...
from utils import utils_sony as utils, helpers
from builders import model_builder

parser = argparse.ArgumentParser()
parser.add_argument('--checkpoint_path', type=str, default='/Users/kaygudo/workspace/ETH/Perception and Learning for Robotics/rough_work/cluster_train_result1/results_batch2_newclass_dataaug/checkpoints/latest_model_FRRN-A_tugraz.ckpt.data-00000-of-00001 ', required=True, help='The path to the latest checkpoint weights for your model.')
...
parser.add_argument('--dataset', type=str, default="sony", required=False, help='The dataset you are using')
...
if not os.path.isdir("%s"%("Test_sony")):
        os.makedirs("%s"%("Test_sony"))
